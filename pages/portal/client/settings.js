...
export async function getServerSideProps({ req }) {
  ...
  return { props: { clientName: client.name, email: client.email } };
}

export default function ClientSettings({ clientName, email }) {
  ...
  async function handleSubmit(e) {
    ...
    setSaved(false);
    setSaving(true);
    const res = await fetch("/api/portal/client/change-password", {
      method: "POST",
