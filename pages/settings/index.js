...
export default function SettingsPage({ settings, adminUsername }) {
  ...
  return (
    <div className="max-w-2xl">
      ...
      <Link
        href="/integrations"
        className="flex items-center justify-between gap-3 mt-6 p-6 bg-white rounded-2xl border border-gray-100 shadow-sm hover:bg-gray-50"
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-medium text-gray-900">ربط API</div>
            <p className="text-sm text-gray-500">
              ربط المتاجر (سلة) وشركات الشحن والمحاسبة (دفترة) — انتقل لصفحة "API".
            </p>
          </div>
        </div>
