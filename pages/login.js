...
export default function Login() {
  ...
  async function handleSubmit(e) {
    ...
    router.replace((router.query.next && String(router.query.next)) || "/");
  }
    ...
    <div dir="rtl" className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-lg font-bold text-gray-900">نظام الفولفيلمنت</h1>
          <p className="text-sm text-gray-500">تسجيل دخول لوحة التحكم</p>
        </div>
