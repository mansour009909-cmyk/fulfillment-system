...
import { LayoutGrid, BookOpen, Package, ClipboardList, AlertTriangle, Users, Store } from "lucide-react";
...
export async function getServerSideProps() {
  ...
  const [shelfCount, bookCount, quantityAgg, ordersThisMonth, inReviewCount, employees, storeOrders] =
    await Promise.all([
      prisma.shelf.count(),
      prisma.book.count(),
...
export default function Home({ stats, employeePerformance, storeStats }) {
